...
namespace Subro.Generators
{
    ...
    ) 
    {
        ...
        public bool IsEmpty => Descriptor == null;
        ...
        public static implicit operator DiagnosticInfo(DiagnosticDescriptor descriptor)
            => new(descriptor, LocationInfo.None);
        ...
        DiagnosticSeverity Severity)
    {
        ...
        public DiagnosticInfo CreateDiagnosticInfo(LocationInfo Location, params object[] messageArgs)
            => new(GetDescriptor(), Location, messageArgs);
    }
    ...
    /// </remarks>
    public class DiagnosticsList : IReadOnlyCollection<DiagnosticInfo>
    {
        ...
        DiagnosticInfo firstEntry;
        List<DiagnosticInfo>? Overflow;

        public void Add(DiagnosticInfo d)
        {
            if (firstEntry.IsEmpty) { firstEntry = d; return; }
        ...
        /// </summary>
        public void SetMain(DiagnosticInfo diagnostic)
        {
            if (firstEntry.IsEmpty) { firstEntry = diagnostic; return; }
        ...
        public IEnumerable<DiagnosticInfo> All =>
            Overflow ?? (firstEntry.IsEmpty ? [] : [firstEntry]);

        public bool IsEmpty => firstEntry.IsEmpty;

        public int Count => firstEntry.IsEmpty ? 0 : Overflow?.Count ?? 1;

        public void AddRange(IEnumerable<DiagnosticInfo> diagnostics)
        {
        ...
        public ImmutableArray<DiagnosticInfo> GetDiagnosticInfos()
        {
            if (firstEntry.IsEmpty) return ImmutableArray<DiagnosticInfo>.Empty;
            if (Overflow == null) return ImmutableArray.Create(firstEntry);
            return Overflow.ToImmutableArray();
        }
        ...
        IEnumerator<DiagnosticInfo> IEnumerable<DiagnosticInfo>.GetEnumerator() => All.GetEnumerator();
    ...
    public static partial class Diagnostics
    {
        ...
        public static ImmutableArray<DiagnosticInfo> CreateInfos(this DiagnosticDescriptor descriptor, ISymbol symbolForLocation, params object[] messageArgs)
            => symbolForLocation.Locations.Length == 0
                ? ImmutableArray.Create(new DiagnosticInfo(descriptor, LocationInfo.None, messageArgs))
